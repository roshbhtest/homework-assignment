...
class TestSimpleStockMarket(unittest.TestCase):
    ...
    def test_calculate_dividend_yield(self):
        self.assertEqual(2.6, self.stock_data.calculate_dividend_yield(stock= 'JOE', ticker_price= 5))
        self.assertEqual(0.4, self.stock_data.calculate_dividend_yield(stock= 'GIN', ticker_price= 5))
        self.assertEqual(0, self.stock_data.calculate_dividend_yield(stock= 'DUMMY', ticker_price= 5))
    ...
    def test_calculate_pe_ratio(self):
        ...
        self.assertIsNone(self.stock_data.calculate_pe_ratio(stock= 'DUMMY', ticker_price= 5))
    ...
    def test_gbce_share_index(self):
        ...
        self.assertAlmostEqual(3.16, stock.gbce_share_index(), places= 2)
